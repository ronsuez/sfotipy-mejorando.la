...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tracks_track', 'file')


    def backwards(self, orm):
        # Adding field 'Track.file'
        db.add_column(u'tracks_track', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2014, 11, 27, 0, 0), max_length=100),
                      keep_default=False)
